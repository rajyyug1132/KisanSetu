        ...
        for test_case in location_tests:
            ...
            if success:
                ...
                if "expected_temp" in test_case:
                    ...
                    if type(actual_temp) in (int, float) or str(actual_temp).isdigit():
                        print(f"   ✅ Temperature structure correct (Live Data): {actual_temp}°C")
                    else:
                        print(f"   ❌ Temperature structure mismatch: expected number, got {actual_temp}")
                        all_passed = False
                ...
                if "expected_humidity" in test_case:
                    ...
                    if type(actual_humidity) in (int, float) or str(actual_humidity).isdigit():
                        print(f"   ✅ Humidity structure correct (Live Data): {actual_humidity}%")
                    else:
                        print(f"   ❌ Humidity structure mismatch: expected number, got {actual_humidity}")
                        all_passed = False
                ...
                if "expected_soil_status" in test_case:
                    ...
                    if isinstance(actual_soil_status, str) and actual_soil_status in ["good", "critical", "low"]:
                        print(f"   ✅ Soil status structure correct (Live Data): {actual_soil_status}")
                    else:
                        print(f"   ❌ Soil status mismatch: expected valid status string, got {actual_soil_status}")
                        all_passed = False
